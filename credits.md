...
### "Plaintiffs by Proxy: A Firm-level Appraoch to WTO Dispute Resolution" (with <a href="http://www.sas.rochester.edu/psc/stone/index.html" target="_blank">Randall W. Stone</a>) | forthcoming at the *<a href="https://link.springer.com/journal/11558" target="_blank">Review of International Organizations</a>*
...
### "Flexibility Mechanisms in Preferential Treaty Agreements and Domestic Politics"

In this chapter, I examine how domestic political forces affect the institutional design of preferential trade agreements (PTAs). When countries sign a regional trade agreement, political leaders vulnerable to domestic groups' protectionist pressures are much more likely to include "escape clauses," which allow contracting parties to shirk their contractual obligations temporarily without violating the terms of the agreement. I ask whether urban-rural biases affect the inclusion of flexibility mechanisms in PTAs. Specifically, leaders in democracy prioritize rural voters over urban ones because of protectionist demands, whereas autocratic leaders are biased in favor of urban populations as they are fearful of urban unrest. To answer this question, I apply a Bayesian Item Response Theory to measure the latent feature of treaty flexibility using a recently developed dataset on the design of trade agreements (DESTA) that covers the most comprehensive items on PTAs. Using this unified measure of treaty flexibility, I test to what extent democratic/autocratic governments have rural/urban biases and how this affects flexible treaty mechanisms in their PTA formations. 
{: style="font-size: 90%"}
